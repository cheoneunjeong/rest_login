  ...
  actions: {
    ...
    loginProcess({commit}, payload) {
      ...
      return new Promise ((resolve, reject) => {
        axios.post('http://localhost:9090/api/auth/signin', payload)
        .then(Response => {
    ...
    SignUp({commit}, payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.post('http://localhost:9090/api/auth/signup', payload)
        .then(Response => {
          console.log(Response.data)
    ...
    boardList({commit}) {
      return new Promise((resolve, reject) => {
        axios.get('http://localhost:9090/api/test/user')
        .then(Response => {
          console.log(Response.data)
    ...
    boardDetail({commit}, payload) {
      return new Promise((resolve, reject) => {
        axios.get('http://localhost:9090/api/test/boardDetail', {
          params: {
            bId: payload
          }
        })
    ...
    BoardDelete({commit}, payload) {
      console.log(payload)
      return new Promise((resolve, reject) => {
        axios.delete('http://localhost:9090/api/test/boardDelete/'+payload.bId)
        .then(Response => {
          console.log(Response.data)
    ...
    boardWrite({commit},payload) {
      return new Promise((resolve, reject) => {
        axios.post('http://localhost:9090/api/test/boardWrite', payload)
        .then(Response => {
          console.log(Response.data)
          if(Response.data === "success") {
    ...
    admin({commit}) {
      ...
      console.log(token)
      return new Promise((resolve, reject) => {
        axios.get('http://localhost:9090/api/admin/adminPage')
        .then(Response => {
          console.log(Response.data)
    ...
    UnpackToken({commit}) {
      return new Promise((resolve, reject) => {
        ...
        axios.get('http://localhost:9090/api/auth/unpackToken')
            .then(Response => {
              console.log(Response.data)
